...
public class GroupModifyRequest extends StringRequest {
    final static private String url = "";
        private Map<String, String> parameters;

    public GroupModifyRequest(String groupID,String groupName, String groupLeader, String groupLeaderName, String groupLeaderID , String groupCategoryNum, ArrayList<String> categoryHead, ArrayList<String> categoryContent, Response.Listener<String> listener) {
