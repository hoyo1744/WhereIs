        ...
        Thread threadGroupList=new Thread(new Runnable() {
            ...
            public void run() {
                if(isPlaying==false) {
                    ...
                    GroupCreateRequest groupCreateRequest = new GroupCreateRequest(strGroupName,strGroupLeaderID,strGroupLeaderName,groupLeaderID,strGroupCategoryNum,categoryHead,categoryContent,responseLister3);
